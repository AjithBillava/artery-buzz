        ...
        <div >
            {
                ...
                <div  className="flex p-2 border-2 border-gray-200 mb-1 ">
                    <Avatar firstname={author?.firstname} lastname={author?.lastname} profilePic={author?author?.profilePic:currentUser?.profilePic}/>
                        ...
                        <div>
                            ...
                            <div className="flex justify-around">
                                <div className="flex items-center">
                                    <svg onClick={()=>handleLikeButton(userId,postId,likedUsers)}  xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 cursor-pointer" title="like" fill={likeButtonColor} viewBox="0 0 24 24" stroke="currentColor">
                ...
                // :
                // <div  className="flex p-2 border-2 border-gray-200 mb-1 ">
                //     <Avatar firstname={currentUser.firstname} lastname={currentUser.lastname} profilePic={currentUser.profilePic}/>

                //     <div className="w-screen ml-2">
                //         <div className="flex" >
                //             <p className="font-bold">{`${currentUser.firstname} ${currentUser.lastname}`}</p>
                //             <p className="ml-2 text-gray-600 " >@{currentUser.username} </p>
                //         </div>
                //         <div>
                //             {content}
                //             <div className="flex justify-around">
